package com.satishlabs.order.client;
...
/**
 * When auth.service.url is set (distributed mode), calls auth-service GET /user/{id}.
 * When not set (monolith), uses UserRepository.
 */
@Component("orderAuthClient")
@Slf4j
